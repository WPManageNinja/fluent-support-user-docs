...
![Select the desired page from the drop-down to show the support portal](/images/setup-configuration/customer-portal/customer-support-portal-setup/support-portal-page.webp)
