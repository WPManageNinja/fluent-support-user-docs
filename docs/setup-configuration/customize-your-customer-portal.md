 ...
 **A. Select MailBox:** Here, you can specify the **Business Inbox** whose tickets you want to display in the customer portal. To learn more about Business Inbox, read this [Documentation](/docs/adding-multiple-business-inboxes).
