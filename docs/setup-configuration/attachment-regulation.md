...
If you want you can add more **Attachment Types** using **Shortcode** if needed. To learn how to add Attachment Types, check this [Documentation](/add-more-attachments-type).
