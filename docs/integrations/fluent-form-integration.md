...
![Enable Fluent Support Integrations](/images/integrations-channels/core-integrations/fluent-form-integration/integration-search-bar-enable-scaled-1.webp)
...
![Settings of a particular form](/images/integrations-channels/core-integrations/fluent-form-integration/forms-particular-form-settings-scaled-1.webp)

Click on **Configure Integrations** , press the **Add New Integration** dropdown, and select **FluentSupport Integration.**

![Enable Fluent Support Feed GIF](/images/integrations-channels/core-integrations/fluent-form-integration/enable-fluent-support-feed.webp)
...
![Add New FluentSupport Integration Feed popup page](/images/integrations-channels/core-integrations/fluent-form-integration/feed-name-business-product-1.webp)
...
![Enable Dynamic Product Section](/images/integrations-channels/core-integrations/fluent-form-integration/check-enable-dynamic-product-selection-1.webp)
...
![Dropdown list for fill in the fields](/images/integrations-channels/core-integrations/fluent-form-integration/ticket-title-content-attachment-priority-1.webp)

Once you are done mapping all your fields, click on the **Save Feed** to save all the settings.

![Save Feed](/images/integrations-channels/core-integrations/fluent-form-integration/save-feed-button-1.webp)
...
![Shortcode to add form on a specific page](/images/integrations-channels/core-integrations/fluent-form-integration/copy-shortcode-scaled-1.webp)
