...
![Start button](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/start-button-1.webp)

Then **create a Bot** by sending the **‘/newbot’** command using the help message.

![Newbot command](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/newbot-command-1.webp)
...
![Get the Bot Token ID](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/get-the-bot-token-id-1.webp)
...
![New Group option](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/new-group-option-1.webp)
...
![Create new telegram group](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/create-new-group-gif-to-webp-converter.webp)
...
![Admin Preview](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/admin-preview-1-1.webp)
...
![Get the Group Chat ID code](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/get-the-group-chat-id-code-1.webp)
...
![Get Telegram Chat ID from GetIDs Bot](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/get-telegram-chat-id-from-getids-1.webp)
...
![Support Staff from Global Settings](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/support-staff-from-globl-settings-1-scaled-1.webp)
...
![Telegram Chat ID Field](/images/integrations-channels/messaging-apps/managing-tickets-using-telegram/telegram-chat-id-field-1-scaled-1.webp)
