...
![Accessing the Agents Reports section from the main navigation](/images/reports-analytics/reports/agents-report/agent-reports-1.webp)
...
![Customizing the agent summary list via the settings pop-up](/images/reports-analytics/reports/agents-report/include-agent-summary-2.webp)
...
![Agents Report Summary](/images/reports-analytics/reports/agents-report/agent-reports-summary-3.webp)
