...
hero:
  ...
  actions:
    - theme: brand
      text: Get Started
      link: /how-to-install-activate-fluent-support
    - theme: alt
      text: Dev Docs
...
features:
  ...
  - icon: ⚡
    ...
    link: /view-manage-ticket-entries
    linkText: Explore
  - icon: 📊
