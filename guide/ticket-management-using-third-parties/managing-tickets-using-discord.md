...
[Original Documentation](https://fluentsupport.com/docs/managing-tickets-using-discord/)
...
![Discord Integration Settings ](public/images/ticket-management-using-third-parties/managing-tickets-using-discord/discord-notification-settings-scaled-1.webp)
...
![Discord Channel settings ](public/images/ticket-management-using-third-parties/managing-tickets-using-discord/discord-channel-for-tickets-1.webp)

Now select the **Integration** from the left sidebar, select the **Webhooks,** and click on the **New Webhook** button.

![Integrations and Webhook](public/images/ticket-management-using-third-parties/managing-tickets-using-discord/discord-integration-settigns-1.webp)

Create a bot here with your relevant name and save it.  
Now click on the **Copy Webhook URL** button to copy the Webhook URL.

![Webhook URL](public/images/ticket-management-using-third-parties/managing-tickets-using-discord/discord-notification-settings-webhook-scaled-1.webp)

Now Paste the Webhook URL in your Fluent Support and click on the **Save Discord Settings** button.

![Save Discord Settings](public/images/ticket-management-using-third-parties/managing-tickets-using-discord/discord-notification-settings-save-scaled-1.webp)

## **Ticket Notification View in Discord** #

In your Discord app, you will see your Ticket Notification like this.

![Ticket Notification View in Discord](public/images/ticket-management-using-third-parties/managing-tickets-using-discord/discord-ticket-notification-1.webp)

If you have any further questions, concerns, or suggestions, please do not hesitate to contact our[ **@support team**](https://wpmanageninja.com/support-tickets/?utm_source=wpmn&utm_medium=home&utm_campaign=site#/). Thank you.

---

**Source:** [Original Documentation](https://fluentsupport.com/docs/managing-tickets-using-discord/)
