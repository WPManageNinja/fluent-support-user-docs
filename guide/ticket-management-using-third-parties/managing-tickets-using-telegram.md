...
![Start button](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/start-button-1.webp)

Then **create a Bot** by sending the **‘/newbot’** command using the help message.

![Newbot command](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/newbot-command-1.webp)
...
![Get the Bot Token ID](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/get-the-bot-token-id-1.webp)
...
![New Group option](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/new-group-option-1.webp)
...
![Create new telegram group](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/create-new-group-gif-to-webp-converter.webp)
...
![Admin Preview](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/admin-preview-1-1.webp)
...
![Get the Group Chat ID code](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/get-the-group-chat-id-code-1.webp)
...
![Configure Telegram Group with FluentSupport](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/configure-telegram-group-with-fluentsupport-1-scaled-1.webp)
...
![Get Telegram Chat ID from GetIDs Bot](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/get-telegram-chat-id-from-getids-1.webp)
...
![Support Staff from Global Settings](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/support-staff-from-globl-settings-1-scaled-1.webp)
...
![Telegram Chat ID Field](public/images/ticket-management-using-third-parties/managing-tickets-using-telegram/telegram-chat-id-field-1-scaled-1.webp)
