...
![Create an app in Dropbox](/guide/public/images/integrations-channels/other/dropbox-integration/dropbox-developer-create-apps-scaled-1.webp)
...
![Create a new app on the DBX Platform popup page](/guide/public/images/integrations-channels/other/dropbox-integration/create-a-new-app-on-the-dbx-platform-scaled.webp)
...
![OAuth2 Redirect URL](/guide/public/images/integrations-channels/other/dropbox-integration/copy-authorixed-url-scaled-1.webp)
...
![Dropbox App Permissions](/guide/public/images/integrations-channels/other/dropbox-integration/permissions-scaled-1.webp)

### Obtain App Credentials 

To obtain the app’s credentials, copy the **App Key** and **App Secret** from your Dropbox app settings.

![Obtain App Credentials](/guide/public/images/integrations-channels/other/dropbox-integration/copy-the-api-key-api-secret-scaled-1.webp)
...
![Client ID, Client Secret and Connect to Dropbox options](/guide/public/images/integrations-channels/other/dropbox-integration/paste-client-id-secret-connect-button-scaled-1.webp)
