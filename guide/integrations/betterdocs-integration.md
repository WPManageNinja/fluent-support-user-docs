...
![Ticket Form Settings from Fluent Support dashboard](public/images/integrations/betterdocs-integration/global-settings-ticket-form-config-scaled-1.webp)
...
![Enable knowledge base suggestion on the ticket creation form box](public/images/integrations/betterdocs-integration/enable-post-type-article-limit-1.webp)
...
![Save settings to make it functional](public/images/integrations/betterdocs-integration/save-settings-1.webp)
