...
![Sure Triggers - Workflows - Create Workflow - Create From Scratch](/images/integrations-channels/core-integrations/suretriggers-integration/1.-create-workflow-button-scaled-1.webp)

Provide a **Name** for your workflow so you can find it easily later, and click the **Create** button.

![Create](/images/integrations-channels/core-integrations/suretriggers-integration/2.-create.webp)
...
![Add Trigger - Plus Icon](/images/integrations-channels/core-integrations/suretriggers-integration/3.-add-trigger-1.webp)
...
![Fluent Support SureTriggers Integration](/images/integrations-channels/core-integrations/suretriggers-integration/4.-fluent-support-trigger-1.webp)
...
![Select Event and Connection](/images/integrations-channels/core-integrations/suretriggers-integration/8.-select-event-and-connection-1.webp)

Here, select the desired **Mailbox** of **Fluent Support** , and click the **Continue** button.

![Select Mailbox](/images/integrations-channels/core-integrations/suretriggers-integration/9.-select-mailbox.webp)
...
![Fetch Data - Save button - SureTriggers](/images/integrations-channels/core-integrations/suretriggers-integration/10.-fetch-data-save-button-1.webp)
...
![Added WooCommerce Trigger - plus icon - SureTriggers](/images/integrations-channels/core-integrations/suretriggers-integration/11.-added-fluentcrm-trigger-plus-icon-1-1.webp)

Type **Fluent Support** in the **Search Bar** or select it from the **Dropdown List** by clicking the **Arrow Icon.**

![Fluent Support Action - SureTriggers Integration](/images/integrations-channels/core-integrations/suretriggers-integration/12.-fluent-support-action-1.webp)
...
![Select event & continue under Fluent Support action](/images/integrations-channels/core-integrations/suretriggers-integration/13.-select-event-continue-under-fluent-support-action-1-1.webp)

Here, select the desired **Mailbox** of **Fluent Support** and**** configure all the necessary data to test the action.

![configure necessary information - suretriggers integration](/images/integrations-channels/core-integrations/suretriggers-integration/14.-configure-necessary-information-1.webp)
...
![Test action - suretriggers](/images/integrations-channels/core-integrations/suretriggers-integration/15.-test-action-1-1-1.webp)
...
![Publish - Save Draft - Suretriggers integration](/images/integrations-channels/core-integrations/suretriggers-integration/16.-publish-button-1-1.webp)
