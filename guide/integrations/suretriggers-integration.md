...
![Sure Triggers - Workflows - Create Workflow - Create From Scratch](public/images/integrations/suretriggers-integration/1.-Create-Workflow-button-scaled.webp)

Provide a **Name** for your workflow so you can find it easily later, and click the **Create** button.

![Create](public/images/integrations/suretriggers-integration/2.-create.webp)
...
![Add Trigger - Plus Icon](public/images/integrations/suretriggers-integration/3.-Add-Trigger.webp)
...
![Fluent Support SureTriggers Integration](public/images/integrations/suretriggers-integration/4.-Fluent-Support-Trigger.webp)
...
![Select Event and Connection](public/images/integrations/suretriggers-integration/8.-Select-Event-and-connection.webp)

Here, select the desired **Mailbox** of **Fluent Support** , and click the **Continue** button.

![Select Mailbox](public/images/integrations/suretriggers-integration/9.-select-mailbox.webp)
...
![Fetch Data - Save button - SureTriggers](public/images/integrations/suretriggers-integration/10.-Fetch-Data-Save-button.webp)
...
![Added WooCommerce Trigger - plus icon - SureTriggers](public/images/integrations/suretriggers-integration/11.-Added-FluentCRM-Trigger-plus-icon-1.webp)

Type **Fluent Support** in the **Search Bar** or select it from the **Dropdown List** by clicking the **Arrow Icon.**

![Fluent Support Action - SureTriggers Integration](public/images/integrations/suretriggers-integration/12.-Fluent-Support-Action.webp)
...
![Select event & continue under Fluent Support action](public/images/integrations/suretriggers-integration/13.-Select-event-continue-under-Fluent-Support-action-1.webp)

Here, select the desired **Mailbox** of **Fluent Support** and**** configure all the necessary data to test the action.

![configure necessary information - suretriggers integration](public/images/integrations/suretriggers-integration/14.-configure-necessary-information-1.webp)
...
![Test action - suretriggers](public/images/integrations/suretriggers-integration/15.-Test-action-1-1.webp)
...
![Publish - Save Draft - Suretriggers integration](public/images/integrations/suretriggers-integration/16.-Publish-button-1.webp)
