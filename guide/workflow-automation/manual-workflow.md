...
![Workflows from Fluent Support Dashboard](public/images/workflow-automation/manual-workflow/dashboard-workflow-add-new-workflow-1-scaled-1.webp)

Give a **Name** to your workflow**,** choose **Manual** type, and click on the **Continue** button to create it.

![Popup page for adding a new workflow](public/images/workflow-automation/manual-workflow/maunal-popup-5.23.59-pm-scaled-1.webp)
...
![Action/s \(Tasks\) for performing Workflow](public/images/workflow-automation/manual-workflow/select-actions-scaled-1.webp)

Multiple actions can be set if needed. To do this, click the **Add Another Action** and follow the same process.

![Add multiple action as per your need](public/images/workflow-automation/manual-workflow/add-another-action-button-scaled-1.webp)
...
![Delete any existing action anytime](public/images/workflow-automation/manual-workflow/delete-workflow-scaled-1.webp)

You can **change the name of your workflow** anytime from here as shown below.

![Change the workflow name anytime](public/images/workflow-automation/manual-workflow/change-the-workflow-name-1-scaled-1.webp)

Also, you can**set the sequence of your added workflow actions/tasks** using the **Drag and Drop Action** icon.

![Drag & Drop feature to set actions/tasks' sequence](public/images/workflow-automation/manual-workflow/drag-drop-feature-to-set-actionstasks-1-1.webp)
...
![Publish the workflow](public/images/workflow-automation/manual-workflow/publish-button-update-workflow-scaled-1.webp)
...
![Open the desired ticket to run the Workflow](public/images/workflow-automation/manual-workflow/workflow-button-in-a-ticket-scaled-1.webp)

Here, you will find the **Workflow Action** you have created before, click on it, and the **Workflow** will be run.

![Run the Workflow](public/images/workflow-automation/manual-workflow/run-the-manual-workflow-drift-video-1.gif)
