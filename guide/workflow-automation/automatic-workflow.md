...
![Workflows from Fluent Support Dashboard](public/images/workflow-automation/automatic-workflow/dashboard-workflow-add-new-workflow-2-scaled-1.webp)

Give a **Name** to your workflow**,** choose **Automatic** type, and click on the **Continue** button to create it.

![Popup page for adding a new workflow](public/images/workflow-automation/automatic-workflow/automatic-popup-scaled-1.webp)
...
![Set Trigger to run workflow](public/images/workflow-automation/automatic-workflow/set-triggers.webp)
...
![Set Condition/s for the Workflow](public/images/workflow-automation/automatic-workflow/set-conditions-scaled.webp)

You can also **Delete** any existing condition by clicking the **Trash** **Icon**.

![Delete any existing condition](public/images/workflow-automation/automatic-workflow/delete-condition-1.webp)
...
![Set Actions \(Tasks\) for workflow](public/images/workflow-automation/automatic-workflow/set-actions-1-1.webp)

Multiple actions can be set if needed. To do this, click the **Add Another Action** button and follow the same process.

![Add multiple action](public/images/workflow-automation/automatic-workflow/set-multiple-actions-scaled-1.webp)
...
![Delete any existing action](public/images/workflow-automation/automatic-workflow/delete-actions-1.webp)

You can **change the name of your workflow** anytime from here as shown below.

![Change name of your workflow](public/images/workflow-automation/automatic-workflow/change-workflow-name.webp)

Also, you can **set the sequence of your added workflow actions/tasks** using the **Drag and Drop Action** icon.

![Drag & Drop feature to set the action/task sequence](public/images/workflow-automation/automatic-workflow/drag-drop-the-actionstasks-2-1.webp)
...
![Publish the workflow](public/images/workflow-automation/automatic-workflow/publish-toggle.webp)
...
![Refund Ticket is bookmarked automatically ](public/images/workflow-automation/automatic-workflow/refund-ticket-scaled-1.webp)
...
![Tickets will be stored under Bookmarked section](public/images/workflow-automation/automatic-workflow/bookmarked-ticket-scaled-1.webp)
