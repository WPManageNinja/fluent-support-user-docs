...
![Enable Fluent Support Integrations
](public/images/integrations-channels/core-integrations/fluent-form-integration/integration-search-bar-enable-scaled-1.webp)
...
![Settings of a particular form](public/images/integrations-channels/core-integrations/fluent-form-integration/forms-particular-form-settings-scaled-1.webp)

Click on **Configure Integrations** , press the **Add New Integration** dropdown, and select **FluentSupport Integration.**

![Enable Fluent Support Feed GIF](public/images/integrations-channels/core-integrations/fluent-form-integration/enable-fluent-support-feed-drift-video-1.gif)
...
![Add New FluentSupport Integration Feed popup page](public/images/integrations-channels/core-integrations/fluent-form-integration/feed-name-business-product-1.webp)
...
![Enable Dynamic Product Section](public/images/integrations-channels/core-integrations/fluent-form-integration/check-enable-dynamic-product-selection-1.webp)
...
![Dropdown list for fill in the fields](public/images/integrations-channels/core-integrations/fluent-form-integration/ticket-title-content-attachment-priority-1.webp)

Once you are done mapping all your fields, click on the **Save Feed** to save all the settings.

![Save Feed](public/images/integrations-channels/core-integrations/fluent-form-integration/save-feed-button-1.webp)
