...
![Settings of a particular form](/guide/public/images/integrations-channels/core-integrations/fluent-form-integration/forms-particular-form-settings-scaled-1.webp)
...
![Add New FluentSupport Integration Feed popup page](/guide/public/images/integrations-channels/core-integrations/fluent-form-integration/feed-name-business-product-1.webp)
...
![Enable Dynamic Product Section](/guide/public/images/integrations-channels/core-integrations/fluent-form-integration/check-enable-dynamic-product-selection-1.webp)
...
![Dropdown list for fill in the fields](/guide/public/images/integrations-channels/core-integrations/fluent-form-integration/ticket-title-content-attachment-priority-1.webp)

Once you are done mapping all your fields, click on the **Save Feed** to save all the settings.

![Save Feed](/guide/public/images/integrations-channels/core-integrations/fluent-form-integration/save-feed-button-1.webp)
...
![Shortcode to add form on a specific page](/guide/public/images/integrations-channels/core-integrations/fluent-form-integration/copy-shortcode-scaled-1.webp)
