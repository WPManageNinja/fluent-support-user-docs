...
![Fluent Support Dashboard](public/images/setup-configuration/business-inboxes/create-business-inbox-initially/Dashboard-of-Fluent-Support-scaled.webp)
Fill out all the necessary information to **set** up your **Support** **Portal,** as shown in the screenshot below.
![Business details for Fluent Support Portal](public/images/setup-configuration/business-inboxes/create-business-inbox-initially/Business-Details.webp)
...
![Adding the Support Portal in desired page using ShortCode](public/images/setup-configuration/business-inboxes/create-business-inbox-initially/select-page-for-shortcode-gfif-drift-video-3918894-4023448-1709375724.gif)
...
![Automatically created Support portal in a separate page](public/images/setup-configuration/business-inboxes/create-business-inbox-initially/automatically-create-page-for-support-portal.gif)
## Preview of Customer Support Portal #
Here you can see the preview of the **Customer Support Portal** using the shortcode.
![Preview of Customer Support Portal using ShortCode](public/images/setup-configuration/business-inboxes/create-business-inbox-initially/5.-Preview-of-Customer-Support-Portal.webp)
