...
![View Settings of specific web-based business inbox](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/view-settings-1-scaled.webp)
You will find two types of **Settings** options (**Inbox** **Settings** & **Email Settings)** to set your Web-Based Inbox.
![Two types of settings option](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/two-types-of-settings-1.webp)
### Inbox Settings #
...
![Inbox Name](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/inbox-name-1.webp)
**Support From Email**  
From here, you will find the email you used to create this business inbox. 
![Support From Email](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/support-from-email.webp)
**Admin Email Address**  
...
![Admin Email Address](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/admin-email-address.webp)
...
![Email Footer for Customers](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/footer-for-customer-1.webp)
**Inbox Color**  
From the Inbox Color drop-down, you can select any color for your business inboxes
![Inbox Colour](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/inbox-color.webp)
...
![Hide Badge Tickets](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/hide-badge-1.webp)
...
![Email Settings of web-based business inbox](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/untitled-26-1.webp)
...
![Enable Email Notification](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/enable-button-for-options-drift-video.gif)
...
To avoid this situation and ensure that any kind of email is delivered without any hassle, we recommend using the **[FluentSMTP](https://fluentsmtp.com/)** plugin. To learn the basic use of the **FluentSMTP** plugin, check this [**Documentation**](https://fluentsmtp.com/docs-category/getting-started/).
![Send Attachments \(Not Recommended\)](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/send-attachments.webp)
...
![Customize your email subject & body using shortcode](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/customize-your-email-content.webp)
...
![Set any web-based inbox as default business inbox](public/images/setup-configuration/business-inboxes/web-based-settings-in-business-inbox/set-as-default-drift-video.gif)
