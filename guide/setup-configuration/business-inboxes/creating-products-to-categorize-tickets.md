...
![Create new products](/guide/public/images/setup-configuration/business-inboxes/creating-products-to-categorize-tickets/add-new-product-1.webp)

Here appears a new popup. Add a relevant **Title** & **Description** for the product, then click the **Add Product** button.

![Add title & description to your product](/guide/public/images/setup-configuration/business-inboxes/creating-products-to-categorize-tickets/create-support-new-product-2.webp)

You will successfully add product. Now, you can **Edit** the product by clicking the **Pencil** icons placed on the right-hand side under the **Actions** column and delete the product by clicking the **three-dots** icon.

![Edit or Delete any product if needed](/guide/public/images/setup-configuration/business-inboxes/creating-products-to-categorize-tickets/edit-or-delete-3.webp)
