...
![Global settings from Fluent Support Dashboard](public/images/setup-configuration/business-inboxes/creating-products-to-categorize-tickets/dashboard-global-settings-1-scaled-1.webp)
Select **Products** from the left sidebar and click on **\+ Create New** to create a new product.
![Create new products](public/images/setup-configuration/business-inboxes/creating-products-to-categorize-tickets/products-create-new-product-1.webp)
Add a relevant **Title** & **Description** for the product, then click the **Create** button.
![Add title & description to your product](public/images/setup-configuration/business-inboxes/creating-products-to-categorize-tickets/title-description-create-1-1.webp)
...
![Edit or Delete any product if needed](public/images/setup-configuration/business-inboxes/creating-products-to-categorize-tickets/edit-or-delete.webp)
