...
![Global Settings from Fluent Support's Dashboard](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/dashboard-global-settings-1-scaled-1.webp)

Click on **Ticket Form Config** from the left sidebar.

![Ticket form configuration options](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/ticket-form-configure-1.webp)
...
![All setting options for Ticket Form Customization](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/ticket-form-settings-new-1.webp)
...
![Knowledge-base suggestions related setting](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/knowledge-base-suggestion-1.webp)

#### Disabled Default Fields #

This setting allows you to disable any of the default fields that you do not want to show on your Ticket Form.

![Setting for disabling any default fields](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/disabled-default-fields1-1.webp)
...
![Setting for disabling rich text editor for frontend](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/disable-rich-text-editor-for-frontend1-1.webp)

#### Required fields for products and services #

With this setting, you can now make your **Product** related fields “**Required”** for your customers on your Ticket Form.

![Setting for making product field required](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/required-product-fields1-1.webp)
...
![Setting for selecting who can access to customer portal](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/access-customer-portal.webp)
...
![Setting for from labels customization](public/images/setup-configuration/ticket-forms-fields/ticket-form-customization/form-labels-customization-1.webp)
