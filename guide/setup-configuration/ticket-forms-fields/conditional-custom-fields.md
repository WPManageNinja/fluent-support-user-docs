...
![Add new Custom Fields from Global Settings in Fluent Support Dashboard](public/images/setup-configuration/ticket-forms-fields/conditional-custom-fields/Dashboard-Add-new-field-scaled.webp)
...
![Choose Filed type from dropdown list](public/images/setup-configuration/ticket-forms-fields/conditional-custom-fields/Field-Type-Add-button-scaled.webp)
...
![Get all integration related Field types](public/images/setup-configuration/ticket-forms-fields/conditional-custom-fields/Integration-related-field-type-scaled.webp)
...
![All the additional fields inside the Add new custom field popup](public/images/setup-configuration/ticket-forms-fields/conditional-custom-fields/Add-new-custom-field-popup-Add-button-scaled.webp)
...
![Options for setting conditional logics](public/images/setup-configuration/ticket-forms-fields/conditional-custom-fields/Set-conditions-options-scaled.webp)
...
![Can add multiple conditions & delete any conditions as per your needs](public/images/setup-configuration/ticket-forms-fields/conditional-custom-fields/condition-plus-icon-trash-icon-condition-match-scaled.webp)

Once you’re done with all the configuration, click **Add**.

![Finally click Add button](public/images/setup-configuration/ticket-forms-fields/conditional-custom-fields/Finally-Add-Button-1-scaled.webp)
