...
description: "A comprehensive guide to monitoring team efficiency, individual agent performance, and exporting support data."
---
...
![Accessing the Agents Reports section from the main navigation](/guide/public/images/reports-analytics/reports/agents-report/agent-reports-1.webp)

## Include Agents in Summary

You can customize which agents appear in your reports by using the settings option.

1.  Click the **Settings (Gear Icon)** located next to the date filter. A pop-up titled **Include Agents in Summary** will appear.
2.  Here, you can select specific agents from the **Available Agents** list and move them to the **Selected Agents** list.
...
![Customizing the agent summary list via the settings pop-up](/guide/public/images/reports-analytics/reports/agents-report/include-agent-summary-2.webp)
...
![Agents Report Summary](/guide/public/images/reports-analytics/reports/agents-report/agent-reports-summary-3.webp)
