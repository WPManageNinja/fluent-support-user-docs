...
This article will help you through the steps required to change your default **Amazon Lambda Cloud Processing** service and implement another one for **[Email Piping](/guide/email-notifications/email-piping-email-based-support-ticket)** in **[Fluent Support](https://fluentsupport.com/).**
