...
![Settings of Microsoft 365 Outlook Web Access](/guide/public/images/email-notifications/forward-from-microsoft365-owa/gear-icon-scaled-1.webp)
...
![Add rules avoid any issues](/guide/public/images/email-notifications/forward-from-microsoft365-owa/add-new-rules-1.webp)
These are the fields under **Rules** that you need to fill in to add the rule.
![Fields of Rules](/guide/public/images/email-notifications/forward-from-microsoft365-owa/add-new-rules-first-look-1.webp)
...
![Process of adding new rules](/guide/public/images/email-notifications/forward-from-microsoft365-owa/add-new-rules-all-settings-drift-video.gif)
