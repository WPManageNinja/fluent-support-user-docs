...
![Tickets from Fluent Support dashboard](public/images/productivity/advanced-filter-fluent-support/fluent-support-ticktes-4-1.webp)

Now go to your desired ticket section from **My Tickets, All Tickets, Unassigned,** or **Bookmarks**.

![All ticket sections](public/images/productivity/advanced-filter-fluent-support/choose-ticket-section-5-1.webp)

Enable the **Advanced Filter** toggle to activate the feature, and the advanced choices will appear.

![Advanced Filter toggle](public/images/productivity/advanced-filter-fluent-support/advanced-filter-toggle-1.webp)

To begin, click the **\+ Add** button, and several **Data Properties** will appear in a popup.

![+ Add button](public/images/productivity/advanced-filter-fluent-support/add-button-1.webp)

Now, you can **use** these **three properties** to set conditions for advanced ticket filtering.

![Three properties](public/images/productivity/advanced-filter-fluent-support/several-categories-1.webp)

Click on **\+ And** to set another condition with the previous condition that you already set.

![ + And button](public/images/productivity/advanced-filter-fluent-support/and-scaled-1.webp)

Or, click on **\+ Or** if you want to set conditions against the previous ones you already set.

![ + Or button](public/images/productivity/advanced-filter-fluent-support/or-1.webp)
...
![Delete Icon or Clear button](public/images/productivity/advanced-filter-fluent-support/deleteclear-filter-1.webp)

To run your conditions, always press the **Filter** button after completing the settings.

![Filter button ](public/images/productivity/advanced-filter-fluent-support/filter-button-1.webp)
...
![Three categories](public/images/productivity/advanced-filter-fluent-support/several-categories-copy-1.webp)
...
![Tickets](public/images/productivity/advanced-filter-fluent-support/tickets-popup-1-1.webp)
...
![Customer](public/images/productivity/advanced-filter-fluent-support/customer-popup-1.webp)
...
![Agent](public/images/productivity/advanced-filter-fluent-support/agent-popup-1.webp)
...
![+ Add or + And button](public/images/productivity/advanced-filter-fluent-support/and-or-add-box-set-conditions-scaled-1.webp)
...
![List of default conditions](public/images/productivity/advanced-filter-fluent-support/list-of-default-conditions-1.webp)
...
![Advanced Filtered Ticket](public/images/productivity/advanced-filter-fluent-support/condition-is-set-1.webp)
