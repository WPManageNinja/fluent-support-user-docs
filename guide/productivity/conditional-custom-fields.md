...
![Add new Custom Fields from Global Settings in Fluent Support Dashboard](public/images/productivity/conditional-custom-fields/Dashboard-Add-new-field-scaled.webp)
...
![Choose Filed type from dropdown list](public/images/productivity/conditional-custom-fields/Field-Type-Add-button-scaled.webp)
...
![Get all integration related Field types](public/images/productivity/conditional-custom-fields/Integration-related-field-type-scaled.webp)
...
![All the additional fields inside the Add new custom field popup](public/images/productivity/conditional-custom-fields/Add-new-custom-field-popup-Add-button-scaled.webp)
...
![Options for setting conditional logics](public/images/productivity/conditional-custom-fields/Set-conditions-options-scaled.webp)
...
![Can add multiple conditions & delete any conditions as per your needs](public/images/productivity/conditional-custom-fields/condition-plus-icon-trash-icon-condition-match-scaled.webp)

Once you’re done with all the configuration, click **Add**.

![Finally click Add button](public/images/productivity/conditional-custom-fields/Finally-Add-Button-1-scaled.webp)

Here, you can see the **Custom Field** has been added to the **Fluent** **Support** **Portal**.

![Customer Support Portal's Ticket Submission Portal](public/images/productivity/conditional-custom-fields/8.-Support-Portal-custom-field.webp)
