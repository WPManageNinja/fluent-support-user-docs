...
![Add workflow from Fluent Support Dashboard](public/images/productivity/outgoing-webhook/Dashboard-Add-new-workflow-scaled.webp)
...
![Fill all information and click continue](public/images/productivity/outgoing-webhook/Workflows-popup-page-continue-button-scaled.webp)
...
![Choose trigger from dropdown](public/images/productivity/outgoing-webhook/workflow-trigger-scaled-1.webp)
...
![Set one or more conditions and delete any if needed](public/images/productivity/outgoing-webhook/set-conditions-trash-icon-scaled-1.webp)

Now, select the “**Trigger** **Outgoing** **Webhook”** action from the dropdown list for **Workflow** to perform.

![Select Outgoing WebHook trigger](public/images/productivity/outgoing-webhook/Set-Outgoing-Webhok-Action.webp)
...
![Fill in all the necessary fields under outgoing webhook](public/images/productivity/outgoing-webhook/Workflow-Action-tasks.webp)
...
![Publish the Workflow](public/images/productivity/outgoing-webhook/Publish-the-workflow.webp)
