...
A **Workflow/Automation** is a sequence of tasks that can be done **Manually** or **[Automatically](/guide/workflows-automation/automatic-workflow)** using certain triggers and conditions to avoid performing the same actions repeatedly. 
