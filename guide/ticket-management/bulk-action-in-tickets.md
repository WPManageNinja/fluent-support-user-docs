...
Each **Icon** performs a certain action in bulk. With the bulk actions what you can perform is explained below –
  ...
  * a) **Reply:** You can add Replies to all the selected tickets in bulk at once.
  * b) **Agent:** You can Assign Agents to all the selected tickets in bulk at once.
  * c) **Workflow:** You can apply workflow on the selected tickets from here.  
  * d) **Tags:** You can apply Tags to all the selected tickets in bulk at once.
