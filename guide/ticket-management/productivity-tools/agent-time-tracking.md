...
![Time Tracking Settings](/guide/public/images/ticket-management/productivity-tools/agent-time-tracking/time-tracking-1.webp)

Go to the specific ticket where you want to use the **Time Tracking**. You’ll see the **Time Logging** option like the below screenshot. Click here to see the time-tracking options.

![Time Tracking in Ticket](/guide/public/images/ticket-management/productivity-tools/agent-time-tracking/time-tracking-2.webp)
...
![Set Estimation](/guide/public/images/ticket-management/productivity-tools/agent-time-tracking/time-tracking-3.webp)
...
When you’re done, click the **Submit Log** button to save the time to your log.

The Time Tracker also shows Time Progress, giving you a clear view based on the logged time.

![Add Log Time](/guide/public/images/ticket-management/productivity-tools/agent-time-tracking/time-tracking-4.webp)
...
![](/guide/public/images/ticket-management/productivity-tools/agent-time-tracking/time-tracking-5.webp)
