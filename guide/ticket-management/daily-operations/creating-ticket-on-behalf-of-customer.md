...
This article will guide you through the process required to **create a ticket** for any customer using the **Add Ticket** functionality of **[Fluent Support](https://fluentsupport.com/)**. (especially in situations where a customer requests your support staff to open a ticket on their behalf).
...
![Tickets from Fluent Support Dashboard](/guide/public/images/ticket-management/daily-operations/creating-ticket-on-behalf-of-customer/dashboard-tickets-2-scaled-1.webp)
...
![Add ticket for customers](/guide/public/images/ticket-management/daily-operations/creating-ticket-on-behalf-of-customer/add-tickets-button-1.webp)

You can reach your customer here by entering the customer’s name or email address into the search box.

![Provide customer name & email](/guide/public/images/ticket-management/daily-operations/creating-ticket-on-behalf-of-customer/customer-name-email-1.webp)
...
![Could not find a contact? Create a new one checkbox](/guide/public/images/ticket-management/daily-operations/creating-ticket-on-behalf-of-customer/couldnt-find-create-a-new-one.webp)
...
![Create a new one option](/guide/public/images/ticket-management/daily-operations/creating-ticket-on-behalf-of-customer/create-a-new-one-next-1-1.webp)
...
![Finally create ticket for customer](/guide/public/images/ticket-management/daily-operations/creating-ticket-on-behalf-of-customer/selected-contact-details-1.webp)
...
**A brief explanation of the settings shown in the screenshot above is given below —**
  ...
  * **Ticket Details:** Here, you can add appropriate ticket details using this **Text** editor. And, to know the details about the **Templates** setting located in the left corner under **Ticket** **Details,[click here](https://fluentsupport.com/docs/templated-saved-replies/).**
