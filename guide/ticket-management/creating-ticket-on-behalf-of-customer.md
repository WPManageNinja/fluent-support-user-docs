...
**A brief explanation of the settings shown in the screenshot above is given below —**
  ...
  * **Ticket Details:** Here, you can add appropriate ticket details using this **Text** editor. And, to know the details about the **Templates** setting located in the left corner under Ticket Details, [click here](/guide/ticket-management/templated-saved-replies.md).
