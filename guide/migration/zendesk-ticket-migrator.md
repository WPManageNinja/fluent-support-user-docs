...
![Ticket migration from Zendesk](/images/migration/zendesk-ticket-migrator/dashboard-zendesk-import-tickets-scaled-1.webp)
...
![Zendesk Domain, Email Address, and API Key](/images/migration/zendesk-ticket-migrator/zendesk-popup-page-scaled-1.webp)
...
![Zendesk Settings Icon](/images/migration/zendesk-ticket-migrator/settings-icon-go-to-admin-center-button-scaled-1.webp)
...
![Get started to get the Zendesk API](/images/migration/zendesk-ticket-migrator/apps-integration-zendesk-api-terms-conditions-get-started-button-scaled-1.webp)
...
![Add API token](/images/migration/zendesk-ticket-migrator/copy-the-api-token-1.webp)

Also, copy **Zendesk’s Domain URL** from the URL section.

![Zendesk’s Domain URL](/images/migration/zendesk-ticket-migrator/copy-the-domain-url-scaled-1.webp)
...
![Finally Import Tickets ](/images/migration/zendesk-ticket-migrator/finally-import-tickets-button-1-scaled-1.webp)
...
![Preview of Imported Tickets from Zendesk](/images/migration/zendesk-ticket-migrator/migrated-tickets-1.webp)
