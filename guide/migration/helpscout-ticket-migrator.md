...
![Import tickets from HelpScout popup in Fluent Support dashboard](/images/migration/helpscout-ticket-migrator/paste-app-id-app-secret-scaled-1.webp)

To obtain the Authorization Code, click the **Get Authorized** button now.

![ Get Authorized option](/images/migration/helpscout-ticket-migrator/get-authorized-button-scaled-1.webp)
...
![Authorization Code field](/images/migration/helpscout-ticket-migrator/paste-the-authorization-code-scaled-1.webp)
...
![Finally Import Tickets ](/images/migration/helpscout-ticket-migrator/finally-import-tickets-button-scaled-1.webp)
