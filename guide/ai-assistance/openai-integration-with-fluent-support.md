...
![OpenAI Integration option from the left sidebar under Global Settings ](public/images/ai-assistance/openai-integration-with-fluent-support/openai-integration-option-under-global-settings-scaled-1.webp)
...
![Login-to-OpenAI](public/images/ai-assistance/openai-integration-with-fluent-support/login-to-openai-scaled-1.webp)

![Enter-email-address-passwrd-Continue-](public/images/ai-assistance/openai-integration-with-fluent-support/enter-email-address-passwrd-continue.webp)

Then, go to **API keys** from **Dashboard,** click on **\+ Create new secret key,** and a popup will appear.

![create-new-secret-key](public/images/ai-assistance/openai-integration-with-fluent-support/create-new-secret-key-scaled.webp)

Now, fill in all the fields with the necessary information and click the **Create secret key** button.

![create-new-secret-key-popup](public/images/ai-assistance/openai-integration-with-fluent-support/create-new-secret-key-popup.webp)

Finally, you will get the OpenAI API key, click the **Copy** button and you will get the API key. The process will be done.

![copy-API-key](public/images/ai-assistance/openai-integration-with-fluent-support/cop-api-key-1.webp)
