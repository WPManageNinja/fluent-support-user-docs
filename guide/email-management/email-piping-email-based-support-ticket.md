...
You must set up **Email Piping** first to use the **Business Inboxes** for **Email-based** support channels in ****[Fluent Support](https://fluentsupport.com/)****. This article will guide you through the steps required for **Email Piping**.
...
![Open desired Business inbox's settings](public/images/email-management/email-piping-email-based-support-ticket/email-piping-dashboard-drift-vid-1.gif)
...
![Get piping email details](public/images/email-management/email-piping-email-based-support-ticket/get-email-piping-details.webp)
...
![Copy Masked Mailbox Email ](public/images/email-management/email-piping-email-based-support-ticket/copy-the-mailbox-email-provided-by-fluent-support.webp)
...
![Discard CC](public/images/email-management/email-piping-email-based-support-ticket/cc-email-discard-1.webp)

You can also add one or more CC emails to send your reply to them. To add CC, click on the **Add CC** button.

![Add CC](public/images/email-management/email-piping-email-based-support-ticket/add-cc.webp)
...
![Add Reply](public/images/email-management/email-piping-email-based-support-ticket/add-reply-button.webp)
