...
![Open settings of Gmail Inbox](public/images/email-management/auto-forward-from-gsuite/gmail-inbox-settings-1.webp)
From **Settings** , click on **Forwarding and POP/IMAP** tab from the top menu.
![Open Forwarding and POP/IMAP tab](public/images/email-management/auto-forward-from-gsuite/forwarding-1.webp)
Click on the **Add a forwarding address** button & a pop-up will appear asking for your forwarding address.
![Enable Add a forwarding address](public/images/email-management/auto-forward-from-gsuite/add-forwarding-address-1.webp)
...
![Add the masked Email address](public/images/email-management/auto-forward-from-gsuite/add-address-next-button-1.webp)
...
![Confirm the email address](public/images/email-management/auto-forward-from-gsuite/verification-mail-to-fluent-support-ticket-1.webp)
...
![Enable Forwarding a copy of incoming mail to option](public/images/email-management/auto-forward-from-gsuite/enable-forward-mail-to-1.webp)
...
![Mailbox is activated](public/images/email-management/auto-forward-from-gsuite/mailbox-active-scaled-1.webp)
