...
This article will guide you through the steps required to forward email from **Outlook Web Access** on **Microsoft 365** (formerly known as **Office 365**), also known as **OWA** , to your **Mailbox** of ********[Fluent Support](https://fluentsupport.com/)********.
...
![Settings of Microsoft 365 Outlook Web Access](public/images/email-management/forward-from-microsoft365-owa/gear-icon-scaled-1.webp)
From the **Mailbox** **Settings** of your **Outlook** mailbox, select **Email** , then **Forwarding,** and click on the **Enable** **forwarding** toggle.
![Enabling Forwarding](public/images/email-management/forward-from-microsoft365-owa/email-forwarding-enable.webp)
Now, paste the **Mailbox Email Address** you got from the **[Email Piping](https://fluentsupport.com/docs/email-piping-email-based-support-ticket/)** settings of **Fluent Support** into the ‘**Forward my email to’** field.
...
![Paste masked email address](public/images/email-management/forward-from-microsoft365-owa/paste-the-mail.webp)
...
![Mailbox is activated](public/images/email-management/forward-from-microsoft365-owa/mailbox-activated-scaled-1.webp)
...
![Add rules avoid any issues](public/images/email-management/forward-from-microsoft365-owa/add-new-rules-1.webp)
These are the fields under **Rules** that you need to fill in to add the rule.
![Fields of Rules](public/images/email-management/forward-from-microsoft365-owa/add-new-rules-first-look-1.webp)
...
![Process of adding new rules](public/images/email-management/forward-from-microsoft365-owa/add-new-rules-all-settings-drift-video.gif)
