  ...
  themeConfig: {
    ...
    sidebar: [
        ...
        items: [
          {
            ...
            collapsed: true,
            items: [
              { text: 'First Business Inbox', link: '/guide/setup-configuration/create-business-inbox-initially' },
      ...
      },
      {
        ...
        items: [
          {
            ...
            collapsed: true,
            items: [
              { text: 'Slack', link: '/guide/integrations-channels/managing-tickets-using-slack' },
              { text: 'Telegram', link: '/guide/integrations-channels/managing-tickets-using-telegram' },
              { text: 'Discord', link: '/guide/integrations-channels/managing-tickets-using-discord' },
              { text: 'WhatsApp', link: '/guide/integrations-channels/managing-tickets-using-whatsapp' },
            ]
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'FluentCRM', link: '/guide/integrations-channels/fluentcrm-integration' },
              { text: 'WooCommerce', link: '/guide/integrations-channels/woocommerce-integration' },
              { text: 'Easy Digital Downloads', link: '/guide/integrations-channels/edd-integration' },
              { text: 'Fluent Forms', link: '/guide/integrations-channels/fluent-form-integration' },
              { text: 'FluentBoards', link: '/guide/integrations-channels/fluentboards-integrations' },
              { text: 'FluentCart', link: '/guide/integrations-channels/fluentcart-integration' },
              { text: 'FluentCommunity', link: '/guide/integrations-channels/fluent-community-integration' },
              { text: 'SureTriggers', link: '/guide/integrations-channels/suretriggers-integration' },
              { text: 'Incoming Webhook', link: '/guide/integrations-channels/incoming-webhook' },
              { text: 'Integration Status', link: '/guide/integrations-channels/integration_statuses' },
            ]
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'LearnDash', link: '/guide/integrations-channels/learndash-integration' },
              { text: 'LifterLMS', link: '/guide/integrations-channels/lifterlms-integration' },
              { text: 'Tutor LMS', link: '/guide/integrations-channels/tutorlms-integration' },
              { text: 'LearnPress', link: '/guide/integrations-channels/learnpress-integration' },
              { text: 'BuddyBoss', link: '/guide/integrations-channels/buddyboss-integration' },
              { text: 'MemberPress', link: '/guide/integrations-channels/memberpress-integration' },
              { text: 'Paid Memberships Pro', link: '/guide/integrations-channels/paid-membership-pro-integration' },
              { text: 'Restrict Content Pro', link: '/guide/integrations-channels/restrict-content-pro-integration' },
              { text: 'WishList Member', link: '/guide/integrations-channels/wishlist-member-integration' },
            ]
          },
          {
            text: 'Other',
        collapsed: true,
        items: [
              { text: 'BetterDocs', link: '/guide/integrations-channels/betterdocs-integration' },
              { text: 'Google reCAPTCHA', link: '/guide/integrations-channels/google-recaptcha-integration' },
              { text: 'Google Drive', link: '/guide/integrations-channels/google-drive-integration' },
              { text: 'Dropbox', link: '/guide/integrations-channels/dropbox-integration' },
            ]
          },
        ]
      },
